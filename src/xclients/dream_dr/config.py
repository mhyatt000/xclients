...
class Config:
    ...
    arrayrecord_output_version: str | None = None  # Optional bumped ArrayRecord version to write with obs.extrs
    arrayrecord_output_dir: Path | None = None  # Optional explicit ArrayRecord output dir; mutually exclusive with version
    arrayrecord_output_overwrite: bool = False  # Replace an existing materialized ArrayRecord output
    ...
    def __post_init__(self) -> None:
        ...
        if self.arrayrecord_output_dir is not None:
            self.arrayrecord_output_dir = self.arrayrecord_output_dir.expanduser().resolve()
